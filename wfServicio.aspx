Johan1219.
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfServicio.aspx.cs" Inherits="wfServicio" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="98%" >
            <tr>
                <td align="left" colspan="2" style="height: 16px">
                    <h4>
                        <asp:Label ID="Label1" runat="server"  Text="ADMINISTRACIÓN DE SERVICIO"></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right" style="width: 60%">
                                <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-primary" Text="GRABAR SERVICIO" OnClick="btnGrabar_Click" />&nbsp;
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label8" runat="server" Text="Nombre del servicio*: "></asp:Label></td>
                            <td align="left" style="width: 40%">
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label4" runat="server" Text="Texto Blacktouch: "></asp:Label></td>
                            <td align="left" style="width: 40%">
                                <asp:TextBox ID="tbBlacktouch" runat="server" CssClass="form-control" Width="80%" MaxLength="80"></asp:TextBox>
                                </td>
                            <td align="left" style="width: 40%">
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label3" runat="server" Text="Servicio Padre: "></asp:Label></td>
                            <td align="left" style="width: 40%">
                                <asp:DropDownList ID="ddlIdServicioPadre" runat="server" CssClass="form-control" Width="80%" MaxLength="100"></asp:DropDownList>
                                </td>
                            <td align="left" style="width: 40%">
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label11" runat="server" Text="Habilitar en Kiosco: "></asp:Label></td>
                            <td align="left" style="width: 40%">
                                <asp:CheckBox ID="cbVisibleKiosco" runat="server"  />
                                </td>
                            <td align="left" style="width: 40%">
                                &nbsp;</td>
                        </tr>
