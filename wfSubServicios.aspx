<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfSubServicios.aspx.cs" Inherits="wfSubServicios" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADMINISTRACIÓN DE SUB-SERVICIOS</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                    <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE SUB-SERVICIOS" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label1" runat="server" Text="NOMBRE SUB-SERVICIO"></asp:Label></td>
                ...
                <td colspan="3">
                    <asp:GridView ID="gvServicios" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvServicios_RowCommand" OnRowDataBound="gvServicios_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Habilitado" HeaderText="VISIBLE" /> 
