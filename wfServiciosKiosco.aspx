<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfServiciosKiosco.aspx.cs" Inherits="wfServiciosAutogestion" %>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE SERVCIOS DE CONSULTA - KIOSCO" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
