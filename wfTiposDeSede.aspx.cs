...
public partial class wfTiposDeSede : System.Web.UI.Page
{
    ...
    {
        DataSet dsTiposDeSede = new DataSet();
        clsblParametricas blParam = new clsblParametricas();
        String msgError;
        String strSQL = "";

        msgError = blParam.ConsultaTiposSede(ref dsTiposDeSede, "", tbNombre.Text);
        if (msgError == "")
        {
            gvOficinas.DataSource = dsTiposDeSede;
            gvOficinas.DataBind();
    ...
    protected void gvOficinas_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToString() == "ADMINISTRAR")
            Response.Redirect("wfTipoDeSede.aspx?id=" + idS);
        if (e.CommandName.ToString() == "CONSULTAR")
            Response.Redirect("wfTipoDeSede.aspx?consulta=si&id=" + idS);
    ...
    protected void btnAgregar_Click1(object sender, EventArgs e)
    {
        Session["tbnombre"] = tbNombre.Text;
        Session["txSQL"] = txSQL.Text;
        Response.Redirect("wfTipoDeSede.aspx");
    }
