<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfServicioAutogestion.aspx.cs" Inherits="wfServicioAutogestion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administración de servicios Autogestión</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="98%">
                <tr>
                    <td align="left" colspan="2" style="height: 16px">
                        <h4>
                            <asp:Label ID="Label1" runat="server" Text="ADMINISTRACIÓN DE SERVICIOS AUTOGESTIÓN"></asp:Label>
                        </h4>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="height: 66px">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right" style="width: 60%">
                                    <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-primary" Text="GRABAR SERVICIO AUTOGESTION" OnClick="btnGrabar_Click" />&nbsp;
<%--                                <asp:Button ID="btnEliminar" runat="server" CssClass="btn btn-danger" Text="ELIMINAR Seccional" OnClick="btnEliminar_Click" /></td>--%>
                            ...
                            <tr>
                                <td align="left" style="width: 20%"></td>
                                <td align="left" style="width: 80%; height: 30px"></td>
<%--                                <td align="left" style="width: 40%"></td>--%>
                            </tr>
                            <tr>
                                <td align="right" style="width: 20%">
                                    <asp:Label ID="Label8" runat="server" Text="NOMBRE DEL SERVICIO DE AUTOGESTIÓN*: "></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td align="left" class="fila1" colspan="2">
                                    <asp:TextBox ID="tbUrl" runat="server" CssClass="form-control" Width="80%" MaxLength="100"></asp:TextBox>
                                </td>
                                <td align="left" style="width: 40%">
                                    <asp:RequiredFieldValidator CssClass="text-danger" ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbUrl"
                                        ErrorMessage="¡Debe escribir el nombre!"></asp:RequiredFieldValidator></td>
...
<%--                            <tr>
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label2" runat="server" Text="HABILITAR SERVICIO"></asp:Label></td>
                            <td align="left" style="width: 40%">
                                <asp:CheckBox ID="cbHabilitaServicio" runat="server" />
                                </td>
                            <td align="left" style="width: 40%">
                                &nbsp;</td>
                        </tr>
