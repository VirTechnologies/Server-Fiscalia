...
public partial class wfPerfilAtencion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (hfid.Value != "")
            {
                msgError = blPara.ConsultaPerfilesAtencion(ref dsPerfiles, hfid.Value, "");
                if (msgError == "")
                {
                    tbNombre.Text = dsPerfiles.Tables[0].Rows[0]["Nombre"].ToString();
                }
            }
            else
                btnEliminar.Visible = false;
    ...
    protected void btnGrabar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            blObj.NombreTabla = "PerfilesDeAtencion";
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        {
            lbConfirmacion.Text = "¡Error eliminando el perfil de atención!" + ex.Message;
            notificacion.Attributes["Class"] = "alert alert-dismissible alert-danger";
            notificacion.Visible = true;
        }
    }
    ...
    {
        Session["Volver"] = "S";
        Response.Redirect("wfPerfilesAtencion.aspx");
    }
}