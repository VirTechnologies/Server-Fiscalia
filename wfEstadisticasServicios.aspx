<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfEstadisticasServicios.aspx.cs" Inherits="wfEstadisticasServicios" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Estadística de turnos por servicios</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="2">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ESTADÍSTICA DE TURNOS POR SERVICIO" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label4" runat="server" Text="SERVICIO: "></asp:Label></td>
                            <td style="width: 40%" class="fila1">
                                <asp:DropDownList ID="ddlServicioId" CssClass="custom-select" Width="80%" runat="server">
                                </asp:DropDownList>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnFiltrar0" runat="server" CssClass="btn btn-primary" Text="ENVIAR ESTADÍSTICAS" OnClick="btnFiltrar0_Click" Visible="false" />
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
        ...
        <table style="width: 90%" id="TablaInfoTurnos" runat="server" visible="false">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvTurnosTotales" runat="server" AutoGenerateColumns="False" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Abreviatura" HeaderText="ABREVIATURA" ItemStyle-CssClass="c"/>
...
<%--            <tr>
   ...
   <%--         <tr>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvAtendidos" runat="server" AutoGenerateColumns="False" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Abreviatura" HeaderText="ABREVIATURA"  ItemStyle-CssClass="c"/>
                            <asp:BoundField DataField="Servicio" HeaderText="SERVICIO" />
                            <asp:BoundField DataField="NoTurnos" HeaderText="NO. DE TURNOS"  ItemStyle-CssClass="c"/>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvCerrados" runat="server" AutoGenerateColumns="False" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Abreviatura" HeaderText="ABREVIATURA"  ItemStyle-CssClass="c"/>
                            <asp:BoundField DataField="Servicio" HeaderText="SERVICIO" />
                            <asp:BoundField DataField="NoTurnos" HeaderText="NO. DE TURNOS"  ItemStyle-CssClass="c"/>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvAbandonados" runat="server" AutoGenerateColumns="False" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Abreviatura" HeaderText="ABREVIATURA"  ItemStyle-CssClass="c"/>
                            <asp:BoundField DataField="Servicio" HeaderText="SERVICIO" />
                            <asp:BoundField DataField="NoTurnos" HeaderText="NO. DE TURNOS"  ItemStyle-CssClass="c"/>
