<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfUsuariosCajas.aspx.cs" Inherits="wfUsuariosCajas" %>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE USUARIOS" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%" >
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR USUARIOS" OnClick="btnFiltrar_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR USUARIO" OnClick="btnAgregar_Click" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvAsesores" runat="server" AutoGenerateColumns="False" Width="100%" AllowSorting="true" OnRowCommand="gvAsesores_RowCommand" OnRowDataBound="gvAsesores_RowDataBound" OnSorting="gvAsesores_Sorting" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Id" HeaderText="ID" />
                            <asp:BoundField DataField="Nombre" SortExpression="Nombre" HeaderText="NOMBRE" />
                            <asp:BoundField DataField="UserName" SortExpression="UserName" HeaderText="LOGIN - CORREO" />
                            <asp:BoundField DataField="Pnombre" SortExpression="Pnombre" HeaderText="PROCEDENCIA" />
                            <asp:BoundField DataField="isAdvisor" SortExpression="isAdvisor" HeaderText="PERFIL EN SECCIONAL" />
                            <asp:ButtonField Text="Sedes" HeaderText="SEDES"/>
                            <asp:ButtonField Text="Consultar" HeaderText="CONSULTAR"/>
                            <asp:ButtonField Text="Editar" HeaderText="EDITAR"/>
                            <asp:ButtonField Text="Cambiar" HeaderText="CONTRASEÑA"/>
                        </Columns>
