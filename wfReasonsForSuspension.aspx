<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfReasonsForSuspension.aspx.cs" Inherits="wfReasonsForSuspension" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administración de razones de suspensión</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN RAZONES DE SUSPENSIÓN" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%" >
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR RAZONES" OnClick="btnFiltrar_Click1" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR RAZÓN DE SUSPENSIÓN" OnClick="btnAgregar_Click1" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvReasons" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvReasons_RowCommand" OnRowDataBound="gvReasons_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="id" HeaderText="id" />
                            <asp:BoundField DataField="Description" HeaderText="DESCRIPCIÓN" />
                            <asp:BoundField DataField="Activity" HeaderText="TIPO ACTIVIDAD" Visible="false" />
