...
public partial class wfEstadisticasTurnos : System.Web.UI.Page
{
    ...
    private void Filtrar()
    {
        ...
        msgError = blEstadi.ConsultaNumeroTurnos(ref dsTurnos, "SOLICITADOS", ddlOficinaId.SelectedValue, tbFechaIni.Text, tbFechaFin.Text);
        if (msgError == "")
        {
        ...
        msgError = blEstadi.ConsultaNumeroTurnos(ref dsTurnos, "LLAMADOS", ddlOficinaId.SelectedValue, tbFechaIni.Text, tbFechaFin.Text);
        if (msgError == "")
        {
            JSonData = "[";
        ...
        msgError = blEstadi.ConsultaNumeroTurnos(ref dsTurnos, "CERRADOS", ddlOficinaId.SelectedValue, tbFechaIni.Text, tbFechaFin.Text);
        if (msgError == "")
        {
            JSonData = "[";
        ...
        msgError = blEstadi.ConsultaNumeroTurnos(ref dsTurnos, "ABANDONADOS", ddlOficinaId.SelectedValue, tbFechaIni.Text, tbFechaFin.Text);
        if (msgError == "")
        {
            JSonData = "[";
...
/*        msgError = blEstadi.ConsultaNumeroTurnosAgendados(ref dsTurnos, "AGENDADOS", ddlOficinaId.SelectedValue, tbFechaIni.Text, tbFechaFin.Text);
        if (msgError == "")
        {
            JSonData = "[";
