...
public partial class wfProcedencia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String msgError;
        DataSet dsProcedencia = new DataSet();
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (hfid.Value != "")
            {
                msgError = blPara.ConsultaProcedencia(ref dsProcedencia, hfid.Value, "");
                if (msgError == "")
                {
                    tbNombre.Text = dsProcedencia.Tables[0].Rows[0]["Nombre"].ToString();
                    if (dsProcedencia.Tables[0].Rows[0]["Habilitado"].ToString() == "True")
    ...
    protected void btnGrabar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            blObj.NombreTabla = "Procedencias";
    ...
    {
        Session["Volver"] = "S";
        Response.Redirect("wfProcedencias.aspx");
    }
}