<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfTiposDeAtencion.aspx.cs" Inherits="wfTiposDeAtencion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administración de tipos de atención</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE TIPOS DE ATENCIÓN"></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label1" runat="server" Text="TIPO DE ATENCIÓN"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR TIPOS DE ATENCIÓN" OnClick="btnFiltrar_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR TIPO DE ATENCIÓN" OnClick="btnAgregar_Click" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvTipos" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvPuestos_RowCommand" OnRowDataBound="gvPuestos_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Id" HeaderText="id" />
                            <asp:BoundField DataField="Nombre" HeaderText="NOMBRE" />
                            <asp:BoundField DataField="IsVisibleInKiosk" HeaderText="VISIBLE EN KIOSCO" />
