<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfEstadisticasTurnosGrupo.aspx.cs" Inherits="wfEstadisticasTurnosGrupo" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Estadísticas números de turnos por Grupo</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="2">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="Estadísticas numéricas de turnos por Grupo" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" class="fila1" align="right">
                                <asp:Label ID="Label4" runat="server" Text="Grupo: "></asp:Label></td>
                            <td style="width: 40%" class="fila1">
                                <asp:DropDownList ID="ddlGrupoId" CssClass="custom-select" Width="80%" runat="server">
                                </asp:DropDownList>
                                </td>
