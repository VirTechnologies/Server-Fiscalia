...
public partial class wfServicioAutogestion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (hfid.Value != "")
            {
                msgError = blPara.ConsultaServiciosConsultaKiosco(ref dsServiciosAtencion, hfid.Value, "");
                if (msgError == "")
                {
   ...
   //         btnEliminar.Visible = false;
    ...
    protected void btnGrabar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            blObj.NombreTabla = "ServiciosConsultas";
...
//            btnEliminar.Visible = false;
    ...
    {
        Session["Volver"] = "S";
        Response.Redirect("wfServiciosKiosco.aspx");
    }
}