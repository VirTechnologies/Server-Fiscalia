...
public partial class wfServiciosAutogestion : System.Web.UI.Page
{
    ...
    private void Filtrar()
    {
        ...
        msgError = blParam.ConsultaServiciosAtencion(ref dsServiciosAtencion, "", tbNombre.Text);
        if (msgError == "")
        {
            gvServiciosAuto.DataSource = dsServiciosAtencion;
            gvServiciosAuto.DataBind();

            if (gvServiciosAuto.Rows.Count <= 0)
            {
            ...
            {
                tbNoRegistros.Text = gvServiciosAuto.Rows.Count.ToString();
    ...
    protected void gvServiciosAuto_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void gvServiciosAuto_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        String idS = "";
        ...
        if (e.CommandName.ToString() == "ADMINISTRAR")
            Response.Redirect("wfServicioAutogestion.aspx?id=" + idS);
        if (e.CommandName.ToString() == "CONSULTAR")
            Response.Redirect("wfServicioAutogestion.aspx?consulta=si&id=" + idS);
    }
    ...
    protected void btnAgregar_Click1(object sender, EventArgs e)
    {
        Session["tbnombre"] = tbNombre.Text;
        Session["txSQL"] = txSQL.Text;
        Response.Redirect("wfServicioAutogestion.aspx");
    }
