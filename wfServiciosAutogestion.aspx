<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfServiciosAutogestion.aspx.cs" Inherits="wfServiciosAutogestion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administración de servcios de autogestión</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE SERVCIOS DE AUTOGESTIÓN" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label1" runat="server" Text="NOMBRE DEL SERVICIO"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR SERVICIOS AUTOGESTIÓN" OnClick="btnFiltrar_Click1" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR UN SERVCIO AUTOGESTIÓN" OnClick="btnAgregar_Click1" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvServiciosAuto" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvServiciosAuto_RowCommand" OnRowDataBound="gvServiciosAuto_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
