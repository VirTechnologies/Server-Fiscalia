...
public partial class wfOficina : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (hfid.Value != "")
            {
                msgError = blPara.ConsultaOficinas(ref dsOficinas, hfid.Value, "");
                if (msgError == "")
                {
                    tbNombre.Text = dsOficinas.Tables[0].Rows[0]["Nombre"].ToString();
                    tbUbicacion.Text = dsOficinas.Tables[0].Rows[0]["Ubicacion"].ToString();
    ...
    protected void btnGrabar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            blObj.Add("Ubicacion", tbUbicacion.Text);
    ...
    {
        Session["Volver"] = "S";
        Response.Redirect("wfOficinas.aspx");
    }
}