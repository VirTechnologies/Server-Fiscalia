<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfGrupos.aspx.cs" Inherits="wfGrupos" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADMINISTRACIÓN DE TEMÁTICAS</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE TEMÁTICAS" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label1" runat="server" Text="NOMBRE TEMÁTICA"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR TEMÁTICAS" OnClick="btnFiltrar_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR UNA TEMÁTICA" OnClick="btnAgregar_Click" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvGrupos" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvGrupos_RowCommand" OnRowDataBound="gvGrupos_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
                            <asp:BoundField DataField="Id" HeaderText="ID" />
                            <asp:BoundField DataField="Nombre" HeaderText="NOMBRE" />
                            <asp:BoundField DataField="Abreviatura" HeaderText="ABREVIATURA" />
                            <asp:BoundField DataField="Grupopadre" HeaderText="GRUPO PADRE" />
            ...
            <tr>
                <td colspan="3">
                    <asp:Table ID="tablaGrupos" runat="server" Width="100%" CssClass="table border-dark table-hover">
                    </asp:Table>
                </td>
            </tr>
            <tr>
