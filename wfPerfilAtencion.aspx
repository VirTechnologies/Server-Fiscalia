<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfPerfilAtencion.aspx.cs" Inherits="wfPerfilAtencion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administración de perfil de atención</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="98%" >
            <tr>
                <td align="left" colspan="2" style="height: 16px">
                    <h4>
                        <asp:Label ID="Label1" runat="server" Text="ADMINISTRACIÓN DE PERFIL DE ATENCIÓN"></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right" style="width: 60%">
                                <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-primary" Text="GRABAR PERFIL" OnClick="btnGrabar_Click" />
                                &nbsp;
                                <asp:Button ID="btnEliminar" runat="server" CssClass="btn btn-danger" Text="ELIMINAR PERFIL" OnClick="btnEliminar_Click" /></td>
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label8" runat="server" Text="NOMBRE PERFIL DE ATENCIÓN*: "></asp:Label></td>
                            <td align="left" style="width: 40%">
