<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfOficinas.aspx.cs" Inherits="wfOficinas" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADMINISTRACIÓN DE PUNTOS DE SECCIONALES</title>
    ...
    <div>
        <table style="width: 99%">
            <tr>
                <td colspan="3">
                    <h4>
                        <asp:Label ID="lTitulo" runat="server" Text="ADMINISTRACIÓN DE SECCIONALES" ></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table style="width: 100%" >
                        <tr>
                            <td style="width: 20%" align="right">
                                <asp:Label ID="Label1" runat="server" Text="NOMBRE SECCIONAL"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnFiltrar" runat="server" CssClass="btn btn-primary" Text="CONSULTAR SECCIONALES" OnClick="btnFiltrar_Click1" />
                            </td>
                            <td>
                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-primary" Text="AGREGAR UNA SECCIONAL" OnClick="btnAgregar_Click1" /></td>
                        </tr>
                    </table>
                    </td>
            </tr>
                ...
                <td colspan="3">
                    <asp:GridView ID="gvOficinas" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvOficinas_RowCommand" OnRowDataBound="gvOficinas_RowDataBound" CssClass="table border-dark table-hover">
                        <Columns>
                            ...
                            <asp:ButtonField Text="TEMÁTICAS" HeaderText="TEMÁTICAS" >
                            </asp:ButtonField>
                        </Columns>
