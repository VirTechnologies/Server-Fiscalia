<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfSubServicio.aspx.cs" Inherits="wfSubServicio" %>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right" style="width: 60%">
                                <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-primary" Text="GRABAR SERVICIO" OnClick="btnGrabar_Click" />&nbsp;<asp:Button ID="btnEliminar" runat="server" CssClass="btn btn-danger" Text="ELIMINAR SERVICIO" OnClick="btnEliminar_Click" /></td>
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label8" runat="server" Text="NOMBRE DEL SUB SERVICIO*: "></asp:Label></td>
                            <td align="left" style="width: 40%">
