...
public partial class wfOficinas : System.Web.UI.Page
{
    ...
    private void Filtrar()
    {
        ...
        msgError = blParam.ConsultaOficinas(ref dsOficinas, "", tbNombre.Text);
        if (msgError == "")
        {
    ...
    protected void gvOficinas_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            LinkButton querytemats = (LinkButton)e.Row.Cells[e.Row.Cells.Count - 1].Controls[0];
            ...
            querytemats.CommandName = "TEMATICAS";
            querytemats.CommandArgument = idS;
    ...
    protected void gvOficinas_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToString() == "ADMINISTRAR")
            Response.Redirect("wfOficina.aspx?id=" + idS);
        if (e.CommandName.ToString() == "CONSULTAR")
            Response.Redirect("wfOficina.aspx?consulta=si&id=" + idS);
        if (e.CommandName.ToString() == "TEMATICAS")
            Response.Redirect("wfTematica.aspx?consulta=si&id=" + idS);
    }
    ...
    protected void btnAgregar_Click1(object sender, EventArgs e)
    {
        Session["tbnombre"] = tbNombre.Text;
        Session["txSQL"] = txSQL.Text;
        Response.Redirect("wfOficina.aspx");
    }
