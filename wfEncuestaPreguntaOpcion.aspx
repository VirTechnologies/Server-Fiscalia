<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfEncuestaPreguntaOpcion.aspx.cs" Inherits="wfEncuestaPreguntaOpcion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edición de opciones de preguntas de encuestas</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="98%" >
            <tr>
                <td align="left" colspan="2" style="height: 16px">
                    <h4>
                    <asp:Label ID="Label1" runat="server"  Text="Administración de opciones de preguntas"></asp:Label>
                    </h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right" style="width: 60%">
                                <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-primary" Text="GRABAR OPCIÓN" OnClick="btnGrabar_Click" />
                                <asp:Button ID="btnEliminar" runat="server" CssClass="btn btn-danger" Text="ELIMINAR OPCION" CausesValidation="False" OnClick="btnEliminar_Click" /></td>
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                <asp:Label ID="Label8" runat="server" Text="Texto opción*: "></asp:Label></td>
                            <td align="left" style="width: 40%">
                                <asp:TextBox ID="tbdescripcion" runat="server" CssClass="form-control" Width="80%" MaxLength="100"></asp:TextBox>
                                </td>
                            <td align="left" style="width: 40%">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 40%">
                                <asp:RequiredFieldValidator CssClass="text-danger" ID="RequiredFieldValidator1" runat="server" ControlToValidate="tborden"
                                    ErrorMessage="¡Debe escribir el orden de la opción!"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
